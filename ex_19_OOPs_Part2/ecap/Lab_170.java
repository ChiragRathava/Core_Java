...
public class Lab_170 {
    public static void main(String[] args) {
        ...
        GoodEcapVWOLogin vwoLogin1 = new GoodEcapVWOLogin("admin","pass123");
//        System.out.println(vwoLogin1.Password);
//        System.out.println(vwoLogin1.username);
//        System.out.println(vwoLogin1.password);
//        vwoLogin1.username = "Rathava";

        vwoLogin1.setUsername("Raj");
        System.out.println(vwoLogin1.getUsername());

        boolean isAdmin = true;
        vwoLogin1.setPassword("124",true);
//        vwoLogin1.setPassword("124",false); // ans. null
